...
SECRET_KEY = 'django-insecure-tu-clave-secreta-aqui'  # Usa tu clave real
DEBUG = True
...
# --- Configuración de producción con Cloudinary ---
if not DEBUG:
    # Hosts y CSRF
    ALLOWED_HOSTS = ['lenceria-fantasia-intima.onrender.com']
    CSRF_TRUSTED_ORIGINS = ['https://lenceria-fantasia-intima.onrender.com']

    # Archivos estáticos
    STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
    STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

    # Archivos de medios en Cloudinary
